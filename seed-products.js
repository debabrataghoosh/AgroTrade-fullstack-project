...
async function seed() {
  ...
  const demoProducts = [
    ...
    {
      title: 'Toor Dal',
      description: 'High-quality toor dal, perfect for traditional Indian dishes.',
      price: 120,
      quantity: 75,
      unit: 'kg',
      image: '/assets/Pulses.png',
    ...
    {
      title: 'Masoor Dal',
      description: 'Red lentils, rich in protein and essential nutrients.',
      price: 95,
      quantity: 60,
      unit: 'kg',
      image: '/assets/Pulses.png',
      category: 'Pulses',
      subcategory: 'Masoor Dal (Red Lentil)',
      seller: seller._id,
    },
    {
    ...
    {
      title: 'Sesame Seeds',
      description: 'Premium sesame seeds, rich in oil content.',
      price: 110,
      quantity: 45,
      unit: 'kg',
      image: '/assets/byproduct.png',
